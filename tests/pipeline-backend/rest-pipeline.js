...
export function CheckList(data) {
  ...
  group("Pipelines API: List pipelines", () => {
    ...
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines`, null, {headers: genAuthHeader(data.userAccessToken, "application/json")}), {
    ...
    // Filtering
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines?filter=mode=MODE_SYNC`, null, { headers: genAuthHeader(data.userAccessToken, "application/json"), }), {
    ...
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines?filter=mode=MODE_SYNC%20AND%20state=STATE_ACTIVE`, null, { headers: genAuthHeader(data.userAccessToken, "application/json"), }), {
    ...
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines?filter=state=STATE_ACTIVE%20AND%20create_time>timestamp%28%222000-06-19T23:31:08.657Z%22%29`, null, { headers: genAuthHeader(data.userAccessToken, "application/json"), }), {
    ...
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines?filter=mode=MODE_SYNC%20AND%20recipe.source=%22${srcConnPermalink}%22`, null, { headers: genAuthHeader(data.userAccessToken, "application/json"), }), {
    ...
    check(http.request("GET", `${pipelineHost}/v1alpha/pipelines?filter=mode=MODE_SYNC%20AND%20recipe.destination=%22${dstConnPermalink}%22%20AND%20recipe.model_instances:%22${modelInstPermalink}%22`, null, { headers: genAuthHeader(data.userAccessToken, "application/json"), }), {
...
export function CheckUpdateState(data) {
