...
import { pipelineHost, connectorHost, modelHost } from "./pipeline-backend/const.js";
const hydraHost = "https://127.0.0.1:4445";
const kratosHost = "https://127.0.0.1:4434";
const apiHost = "https://127.0.0.1:8000"; // 

import * as constant from "./pipeline-backend/const.js";
import * as pipeline from './pipeline-backend/rest-pipeline.js';
import * as triggerSync from './pipeline-backend/rest-trigger-sync.js';
import * as triggerAsync from './pipeline-backend/rest-trigger-async.js';
...
export default function (data) {
  ...
  pipeline.CheckUpdateState(data)
  pipeline.CheckRename(data)
  pipeline.CheckLookUp(data)

  triggerSync.CheckTriggerSyncSingleImageSingleModelInst(data)
  triggerSync.CheckTriggerSyncMultiImageSingleModelInst(data)
  triggerSync.CheckTriggerSyncMultiImageMultiModelInst(data)

  triggerAsync.CheckTriggerAsyncSingleImageSingleModelInst(data)
  triggerAsync.CheckTriggerAsyncMultiImageSingleModelInst(data)
  triggerAsync.CheckTriggerAsyncMultiImageMultiModelInst(data)
